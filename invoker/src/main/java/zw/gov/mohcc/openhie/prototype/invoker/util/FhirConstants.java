package zw.gov.mohcc.openhie.prototype.invoker.util;
...
public class FhirConstants {
    ...
    public static final String FHIR_TERMINOLOGY_PROVENANCE_PARTICIPANT_TYPE = "http://terminology.hl7.org/CodeSystemprovenance-participant-type";
    public static final String FHIR_TERMINOLOGY_PARTICIPATION_TYPE = "http://terminology.hl7.org/CodeSystemv3-ParticipationType";
    public static final String DIAGNOSTIC_REPORT_SERVICE_SYSTEM_URI = "http://terminology.hl7.org/CodeSystem/v2-0074";
    public static final String INTERPRETATION_SYSTEM_URI = "http://terminology.hl7.org/CodeSystem/v3-ObservationInterpretation";
    public static final String ALLERGY_INTOLERANCE_CLINICAL_STATUS_SYSTEM_URI = "http://terminology.hl7.org/CodeSystem/allergyintolerance-clinical";
    public static final String ALLERGY_INTOLERANCE_VERIFICATION_STATUS_SYSTEM_URI = "http://terminology.hl7.org/CodeSystem/allergyintolerance-verification";
    public static final String CONDITION_CLINICAL_STATUS_SYSTEM_URI = "http://terminology.hl7.org/CodeSystem/condition-clinical";
    public static final String CONDITION_CLINICAL_STATUS_SYSTEM_URI_R3 = "http://hl7.org/fhir/condition-clinical";
    public static final String CONDITION_VERIFICATION_STATUS_SYSTEM_URI = "http://terminology.hl7.org/CodeSystem/condition-ver-status";
    public static final String CONDITION_VERIFICATION_STATUS_SYSTEM_URI_R3 = "http://hl7.org/fhir/condition-ver-status";
    public static final String CLINICAL_FINDINGS_SYSTEM_URI = "http://terminology.hl7.org/CodeSystem/clinical-findings";
    public static final String TASK_STATUS_VALUE_SET_URI = "http://hl7.org/fhir/task-status";
    public static final String OBSERVATION_REFERENCE_RANGE_SYSTEM_URI = "http://terminology.hl7.org/CodeSystem/referencerange-meaning";
